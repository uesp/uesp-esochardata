...
class EsoBuildDataParser
{
	...
	public function createTables()
	{
		...
		$query = "CREATE TABLE IF NOT EXISTS characters (
						...
						uniqueAccountName TINYTEXT NOT NULL DEFAULT '',
						wikiUserName TINYTEXT NOT NULL DEFAULT '',
						class TINYTEXT NOT NULL DEFAULT '',
						race TINYTEXT NOT NULL DEFAULT '',
						alliance TINYTEXT NOT NULL DEFAULT '',
						buildType TINYTEXT NOT NULL DEFAULT '',
						special TINYTEXT NOT NULL DEFAULT '',
						...
						charIndex TINYINT NOT NULL DEFAULT 0,
		...
		$query = "CREATE TABLE IF NOT EXISTS equipSlots (
						...
						enchant TINYTEXT NOT NULL DEFAULT '',
						INDEX index_characterId(characterId),
		...
		$query = "CREATE TABLE IF NOT EXISTS skills (
						...
						area TINYTEXT NOT NULL DEFAULT '',
						cost TINYTEXT NOT NULL DEFAULT '',
						`range` TINYTEXT NOT NULL DEFAULT '',
						radius TINYTEXT NOT NULL DEFAULT '',
						castTime TINYTEXT NOT NULL DEFAULT '',
		...
		$query = "CREATE TABLE IF NOT EXISTS championPoints (
						...
						description TEXT NOT NULL DEFAULT '',
						abilityId INTEGER NOT NULL DEFAULT '0',
						slotIndex TINYINT NOT NULL DEFAULT '0',
						INDEX index_characterId(characterId)
					) ENGINE=MYISAM;";
		...
		$query = "CREATE TABLE IF NOT EXISTS screenshots (
						...
						origFilename TEXT NOT NULL DEFAULT '',
		...
		$query = "CREATE TABLE IF NOT EXISTS combatActions (
						id INTEGER NOT NULL AUTO_INCREMENT,
						characterId INTEGER NOT NULL,
						rotationName TINYTEXT NOT NULL DEFAULT '',
						playerActions TEXT NOT NULL DEFAULT '',
						PRIMARY KEY (id),
						INDEX index_characterId(characterId)
					) ENGINE=MYISAM;";
	...
	public function checkBuffVampire(&$buildData)
	{
		$buffs = &$buildData['Buffs'];
		if ($buffs == null) return false;
		...
		foreach ($buffs as $buff)
		{
			if (substr($buff['name'], 0, 13) == "Vampire Stage") return true;
		}
