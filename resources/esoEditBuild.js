...
[
	...
	},
	{
		...
		"enabled": false,
		"enableOffBar": true,
		"match": /When you leave Sneak, invisibility, or Major Expedition ends while in combat, your damage done is increased by ([0-9]+)% for/i
	},
	{
...
[
	...
	},
	{
		...
		display: "%",
		match: /WITH RESTORATION STAFF EQUIPPED\s+Your fully-charged Heavy Attacks restore ([0-9]+\.?[0-9]*)% more Magicka/i,
	},
	{
		statRequireId: "WeaponRestStaff",
		statRequireValue: 1,
		...
		display: "%",
		match: /WITH RESTORATION STAFF EQUIPPED\s+Increases healing with Restoration Staff spells by ([0-9]+\.?[0-9]*)%/i,
	},
	{
		id: "Essence Drain",
		baseSkillId: 30973,
		...
		toggle: true,
		enabled: false,
		match: /WITH RESTORATION STAFF EQUIPPED\s+You gain Major Mending for [0-9]+\.?[0-9]* seconds after completing a fully-charged Heavy Attack/i,
	},
	{
		...
		toggle: true,
		enabled: false,
		match: /WITH RESTORATION STAFF EQUIPPED\s+Increases your healing by ([0-9]+\.?[0-9]*)% on allies under [0-9]+\.?[0-9]*% Health/i,
	},
	{
		...
		display: "%",
		maxTimes: 5,
		match: /WITH A BOW EQUIPPED\s+Dealing damage with a Light or Heavy Attack increases the damage of your Bow abilities by ([0-9]+\.?[0-9]*)% for [0-9]+ seconds, stacking up to [0-9]+ times/i,
	},
	{
		statRequireId: "WeaponBow",
		statRequireValue: 1,
	...
	},
	{
		...
		category: "Skill2",
		statId: "WeaponCrit",
		match: /WITH BOW EQUIPPED\s+Increases your Critical Chance rating by ([0-9]+)/i,
	},
	{
		statRequireId: "WeaponBow",
		statRequireValue: 1,
	...
	},
	{
		...
		"statId": "Dual_Wield",
		"display": "%",
		"match": /WHILE DUAL WIELDING\s+Increases damage with Dual Wield abilities by ([0-9\.]+)%/i
	},
	{
		"id": "Follow Up",
		"baseSkillId": 29389,
		...
		"display": "%",
		"match": /When you complete a fully-charged Heavy Attack, your next direct damage attack used within [0-9]+ seconds deals an additional ([0-9\.]+)% damage/i
	},
	{
		"id": "Battle Rush",
		"baseSkillId": 29391,
		...
		"statId": "StaminaRegen",
		"display": "%",
		"match": /Increases your Stamina Recovery by ([0-9\.]+)% for [0-9]+ seconds after killing a target/i
	},
	{
		"statRequireId": "Weapon2H",
		"statRequireValue": 1,
	...
	},
	{
		...
		"statId": "WeaponDamage",
		"display": "%",
		"match": /WITH ONE HAND WEAPON AND SHIELD EQUIPPED\s+Increases your Weapon and Spell Damage by ([0-9\.]+)%/i
	},
	{
		"statRequireId": "Weapon1HShield",
		"statRequireValue": 1,
	...
	},
	{
		...
		"statId": "BlockMitigation",
		"display": "%",
		"match": /and the amount of damage you can block by ([0-9\.]+)%/i
	},
	{
		"statRequireId": "Weapon1HShield",
		"statRequireValue": 1,
		...
		"display": "%",
		"match": /WITH ONE HAND WEAPON AND SHIELD EQUIPPED\s+Increases the amount of damage you can block from projectiles and ranged attacks by ([0-9\.]+)%/i
	},
	{
	...
	},
	{
		...
		"factorStatId": "ArmorMedium",
		"factorValue": -1,
		"match": /Reduces the cost of Sneak by ([0-9.]+)% for each piece of Medium Armor/i
	},
	{
...
window.ESO_CPEFFECT_MATCHES = [
	{
		...
		statId: "DamageDone",
		display: "%",
		match: /Increases your damage done against Off Balance enemies by [0-9\.]+% per stage.*\s*Current bonus: ([0-9\.]+)%/i,
	},
	{
		id: "Foresight",
		toggle: true,
...
[
	...
	{
		buffId: "Minor Heroism",
		match: /Minor Endurance, Minor Heroism, Minor Slayer, Minor Aegis, and Empower/i,
	},
	{
		buffId: "Minor Slayer",
		match: /Minor Endurance, Minor Heroism, Minor Slayer, Minor Aegis, and Empower/i,
	...
	},
	{
		...
		enabled: false,
		buffId: "Empower",
		rawInputMatch: /(When you use a fully charged Heavy Attack you gain Empower for [0-9]+ seconds, increasing the damage of your Heavy Attacks against monsters by [0-9]+%)/i,
		match: /When you use a fully charged Heavy Attack you gain Empower for [0-9]+ seconds, increasing the damage of your Heavy Attacks against monsters by/i,
	},
	{
		id: "The Arch-Mage",
		setBonusCount: 4,
	...
	},
	{
		...
		statId: "SpellDamage",
		maxTimes: 10,
		match: /Standing in the ring grants you a stack of Siroria's Boon, increasing your Weapon and Spell Damage by ([0-9]+) for /i,
	},
	{
		id: "Mantle of Siroria",
		setBonusCount: 4,
